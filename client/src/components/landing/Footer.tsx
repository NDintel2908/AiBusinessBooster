        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 font-primary">
              ...
              <li><a href="#features-section" className="text-gray-400 hover:text-neon-blue transition duration-300" onClick={(e) => { e.preventDefault(); document.getElementById('features-section')?.scrollIntoView({ behavior: 'smooth' }); }}>Tính năng</a></li>
