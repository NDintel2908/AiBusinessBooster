            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">(+84) 767 259 921</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">info@bcp.global</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">224A Dien Bien Phu Str., Vo Thi Sau Ward, District 3, HCMC, Vietnam</p>
                </div>
              </div>
            </div>
