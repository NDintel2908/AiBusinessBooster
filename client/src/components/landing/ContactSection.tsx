        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-orbitron font-bold mb-6 text-white">
              Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-electric-purple">Transform</span> Your Business Connections?
            </h2>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-orbitron font-semibold mb-2 text-white">Phone</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-orbitron font-semibold mb-2 text-white">Email</h3>
                  <p className="text-gray-300">info@nexusmatch.ai</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-orbitron font-semibold mb-2 text-white">Location</h3>
                  <p className="text-gray-300">123 Innovation Drive, Silicon Valley, CA 94043</p>
                </div>
              </div>
            </div>
            
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-card-bg border border-gray-700 flex items-center justify-center text-gray-400 hover:text-neon-blue hover:border-neon-blue transition duration-300">
