      ...
      <section id="pricing" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10">
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-8 max-w-4xl mx-auto border border-blue-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a 
                  href="/contact"
                  className="text-purple-400 hover:text-blue-400 transition-colors duration-300 inline-flex items-center justify-center px-6 py-3 rounded-lg border border-purple-400/30 hover:border-blue-400/50"
                >
                  Tư vấn miễn phí
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
