...
export function HelpButton() {
  ...
  const buttonStyle: React.CSSProperties = {
    ...
    bottom: '20px',
    right: '20px',
    backgroundColor: isHovered ? '#205295' : '#2C74B3',
    color: 'white',
    borderRadius: '50%',
    width: '60px',
    height: '60px',
    ...
    cursor: 'pointer',
    boxShadow: isHovered 
      ? '0px 4px 15px rgba(44, 116, 179, 0.5), 0px 0px 20px rgba(44, 116, 179, 0.3)' 
  ...
  const menuOptions = [
    {
      ...
      icon: '/images/icon/Icon_of_Zalo.svg',
      color: '#0068FF'
    },
    {
    ...
    },
    {
      ...
      icon: '/images/icon/whatsapp-svgrepo-com.svg',
      color: '#25d366'
    }
  ];
      ...
      <style>
        {`
          @keyframes pulse {
            ...
            100% {
              box-shadow: 0 0 0 0 rgba(44, 116, 179, 0);
            }
          }
        `}
      </style>
