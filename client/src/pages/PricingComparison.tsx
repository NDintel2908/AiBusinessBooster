      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-gray-300 font-primary max-w">
            Lựa chọn gói dịch vụ phù hợp với nhu cầu kinh doanh của bạn. So sánh
            các tính năng và đặc quyền để có quyết định đúng đắn.
          </p>
        </motion.div>
        ...
        >
          <table className="w-full border-collapse mb-10">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700 text-center">
                  <p>
                    <span className="font-bold text-red-500">1200 USD/năm</span>
                  </p>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700">
                  Xác thực cấp độ cao nhất
                  <br />
                  (verified nhận tích xanh)
                </td>
                <td className="px-4 py-3 border border-gray-700 text-center">
              ...
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700">
                  Hiển thị trên top qua keyword
                  <br />
                  (được chọn lọc & hiển thị top bởi
                  <br />
                  AI gần với các keywords)
                </td>
                <td className="px-4 py-3 border border-gray-700 text-center">
                  <span className="text-red-500">✕</span>
                </td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700">
                  Chi phí cho 1 lượt trò chuyện cùng đối tác
                </td>
                <td className="px-4 py-3 border border-gray-700 text-center">
                  500.000 VND/lượt
                </td>
                ...
                >
                  <span className="text-white-500">
                    Được 10 kết nối mới mỗi tháng
                    <p>Không áp dụng cộng dồn </p>
                  </span>
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700">
                  Dữ liệu DN được training riêng bởi human & AI
                </td>
                <td className="px-4 py-3 border border-gray-700 text-center">
                  <span className="text-red-500">✕</span>
                </td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700">
                  Được ưu tiên trải nghiệm các tính năng AI mới
                </td>
                <td className="px-4 py-3 border border-gray-700 text-center">
                  <span className="text-red-500">✕</span>
                </td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700">
                  Mời tham gia các sự kiện chương trình kết nối giao thương
                  global của BCP
                </td>
                <td className="px-4 py-3 border border-gray-700 text-center">
                  <span className="text-red-500">✕</span>
              ...
              <tr>
                ...
                <td className="px-4 py-3 border border-gray-700">
                  Được mời tham gia đào tạo AI và kết nối với hệ sinh thái
                  AIPartners.asia
                </td>
                <td className="px-4 py-3 border border-gray-700 text-center">
                  <span className="text-red-500">✕</span>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 border border-gray-700">
                    <p>
                      <strong>Gửi</strong>: 20 USD = 500,000 VND/lượt ~ 100
                      credits
                    </p>
                  </td>
                </tr>
          ...
          <div className="bg-gray-800/30 p-6 rounded-lg border border-gray-700 mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 font-primary text-gray-300">
              ...
              <li>
                Đăng ký gói Premium Company năm sẽ được ưu đãi 2 tháng miễn phí.
              </li>
              <li>
                Xác thực cấp độ cao nhất giúp tăng độ tin cậy và tỷ lệ kết nối
                thành công.
              </li>
              <li>
                Slot Connecting có thể được mua riêng lẻ hoặc kết hợp với các
                gói dịch vụ khác.
              </li>
            </ul>
          </div>
